...
public class DefaultLoader implements CommandLineRunner {
    ...
    private void loadSecurityData() {
        ...
        authorityRepository.saveAll(Arrays.asList(createDeck, readDeck, updateDeck, deleteDeck));
        authorityRepository.saveAll(Arrays.asList(createFlashcard, readFlashcard, updateFlashcard, deleteFlashcard));
